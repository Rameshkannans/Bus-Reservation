  ...
  <!-- NAvigation Bar end -->
            ...
            <ul class="navbar-nav ">
              ...
              <div class="collapse navbar-collapse" id="rks">
                  <ul class="navbar-nav ms-auto ">
                    <li class="nav-item">
                      <a class="nav-link text-dark text-center px-4" style="font-size: 17px;" id="b1" href="#">P r o j e c t  s</a>
                  </li> 
                    </ul>
                    <ul class="navbar-nav">
                      <li class="nav-item">
                        <a class="nav-link text-dark text-center px-4" style="font-size: 17px;" id="b1" href="#">A b o u t</a>
                      </li> 
                    </ul>
                    <ul class="navbar-nav">
                      <li class="nav-item">
                        <a class="nav-link text-dark text-center px-4" style="font-size: 17px;" id="b1" href="#">C o n t a c t</a>
                      </li> 
                    </ul>
          </div>
        </div>
   ...
   <div class="position-relative">
    ...
    <div class="position-absolute top-50 start-50 t1">
      <h1 class="text-white"><b class="bg-dark text-white p-1" style="opacity: 0.7;">BR</b> Architects</h1>
    </div>
   </div>
   <!-- First big image end -->

    <!-- Projects start -->
    <h5 class="p-4">Projects<hr> </h5>
    <div class="container-fluid bg-white px-4">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card img-fluid">
              ...
              <div class="card-img-overlay">
                <a href="" class="btn btn-dark" style="position: absolute; top: 0; left: 0; z-index: 1;">Summer House</a>
              </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
          <div class="card img-fluid">
              ...
              <div class="card-img-overlay">
                <a href="" class="btn btn-dark" style="position: absolute; top: 0; left: 0; z-index: 1;" >Brick House</a>
              </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
          <div class="card img-fluid">
              ...
              <div class="card-img-overlay">
                <a href="" class="btn btn-dark" style="position: absolute; top: 0; left: 0; z-index: 1;">Renovated</a>
              </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
         <div class="card img-fluid">
              ...
              <div class="card-img-overlay">
                <a href="" class="btn btn-dark" style="position: absolute; top: 0; left: 0; z-index: 1;">SBarn House</a>
              </div>
            </div>
        </div>
      </div>
      ...
      <div class="row mt-4">
        <div class="col-sm-6 col-lg-3">
          <div class="card img-fluid">
              <img class="card-img-top" src="b5.jpg" alt="Card image" style="width:100%">
              <div class="card-img-overlay">
                <a href="" class="btn btn-dark" style="position: absolute; top: 0; left: 0; z-index: 1;">Summer House</a>
              </div>
            </div>
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card img-fluid">
              <img class="card-img-top" src="b6.jpg" alt="Card image" style="width:100%">
              <div class="card-img-overlay">
                <a href="" class="btn btn-dark" style="position: absolute; top: 0; left: 0; z-index: 1;">Brick House</a>
              </div>
            </div>
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card img-fluid">
              <img class="card-img-top" src="b5.jpg" alt="Card image" style="width:100%">
              <div class="card-img-overlay">
                <a href="" class="btn btn-dark" style="position: absolute; top: 0; left: 0; z-index: 1;">Barn House</a>
              </div>
            </div>
        </div>
      </div>
    ...
    <!-- Footer start -->
    <div class="container-fluid bg-dark p-4 mt-2">
      <h6 class="text-center text-white">Powered by <a href="#">W3.css</a> </h6>
    </div>
    <!-- Footer end -->
</body>
</html>