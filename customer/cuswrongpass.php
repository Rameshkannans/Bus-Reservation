            ...
            <div class="row justify-content-center ">
                <div class="col-md-5 p-5 shadow-lg">
                    <div class="card text-center bg-transparent shadow-lg">
                        ...
                        <div class="card-body">
                            <h4 class="text-white">Please enter correct retype password</h4>

                              <div class="text-center mt-4">        
                                <h6 class="link text-primary">Go to Register page.. <a href="cusreg.php" class="btn btn-outline-warning "><b>Register here</b> </a></h6>
                              </div>
                        </div>
                    </div>
                </div>
