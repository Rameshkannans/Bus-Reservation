  ...
  <div class="row">
      <div class="col-lg-12 col-sm-12 bg-transparent ms-4 me-5  p-2">
        <div class="card p-2 shadow-lg bg-transparent">
          <h3 class="card-header text-center text-warning" ><b>CUSTOMER REGISTRATION</b></h3>
          <form action="" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-sm-12 pt-2">
              <div class="mb-3">
                <label for="cname" class="form-label text-info"><b>Name :</b></label>
            ...
            <div class="text-center mt-4">        
              <h6 class="link">Already have an account? <a href="cuslogin.php" class="btn btn-outline-warning "><b>Login here</b> </a></h6>
            </div>
