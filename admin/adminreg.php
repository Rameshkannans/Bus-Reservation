        ...
        <div class="bg-white p-5 mt-4 mb-4 backg " style="border-radius: 15px; height: 580px;">
          ...
          <div class="row text-center">
            ...
            <div class="col-lg-12 col-sm-12 bg-transprent " >
              <h1 class="text-warning" style="font-family: 'Grand Hotel'; color: white;">Admin Register</h1>
            </div>

            <div class="col-lg-5 col-sm-12 bg-transprent mx-auto" >
              <div class="card  bg-transparent" style="border:0px;">
                <img src="us.png" class="rounded-circle mx-auto" style="width: 200px;">
                <div class="card-body">
                  <a href="areg.php" class="btn btn-outline-warning p-4"><b> REGISTER</b></a>
                </div>
              </div>
            </div>
